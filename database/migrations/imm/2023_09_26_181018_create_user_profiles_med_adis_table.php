...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_imm')->create('user_profiles_medicalservices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_imm')->dropIfExists('user_profiles_med_adis');
    }
};
